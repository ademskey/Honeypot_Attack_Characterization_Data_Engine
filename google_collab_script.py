...
dotenv_path = '/content/drive/MyDrive/Google_collab/.env'
...
proxies = {
    "http": "socks5h://2.tcp.us-cal-1.ngrok.io:12984",
    "https": "socks5h://2.tcp.us-cal-1.ngrok.io:12984"
}
...
for i in range(hours_to_fetch):
    ...
    # Check for user input to exit
        if sys.stdin.isatty():  # Only true in real terminal
            import select
