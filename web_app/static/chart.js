async function renderCharts() {
    ...
    const chart1 = createBarChart("Chart1", top10DestPorts, `Top ${chart1Limit} Destination Ports`);
    ...
    const chart4 = createBarChart("Chart4", attacksPerType, "Number of Attacks Per Honeypot");
